...
- `Category` 1 to N `Product`: В категорії може міститися багато товарів, але товар належить лише одній категорії.
- `Customer` 1 to N `Order`: Один покупець може зробити багато замовлень.
- `Order` 1 to N `OrderItem`: Одне замовлення містить багато позицій у чеку.
- `Product` 1 to N `OrderItem`: Один товар може фігурувати в багатьох позиціях замовлень.
